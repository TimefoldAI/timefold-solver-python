...
xref:constraints-and-score/score-calculation.adoc#incrementalScoreCalculation[Incremental Python score calculation] does not support score explanation.
xref:constraints-and-score/score-calculation.adoc#easyScoreCalculation[Easy Python score calculation] does not support score explanation.
====
...
Typically, the scoring engine creates justification objects automatically by using the results of xref:constraints-and-score/score-calculation.adoc#constraintStreamsCustomizingJustificationsAndIndictments[Constraint Streams' `justify_with(...)` call].
