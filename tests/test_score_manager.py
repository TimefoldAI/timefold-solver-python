...
def test_solver_manager_score_manager():
    with timefold.solver.solver_manager_create(solver_config) as solver_manager:
        assert_score_manager(timefold.solver.score_manager_create(solver_manager))


def test_solver_factory_score_manager():
    assert_score_manager(timefold.solver.score_manager_create(timefold.solver.solver_factory_create(solver_config)))
