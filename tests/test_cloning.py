...
class ExampleEntity:
    code: str
    value: Annotated[ExampleValue, timefold.solver.PlanningVariable]
...
class ExampleExtendedThirdpartyEntity(ThirdpartyEntity):
    ...
    def get_value(self) -> Annotated[ExampleValue, timefold.solver.PlanningVariable]:
        return self.value
...
class ExampleSolution:
    code: str
    value_list: Annotated[List[ExampleValue], timefold.solver.ProblemFactCollectionProperty]
    entity_list: Annotated[List[ExampleEntity], timefold.solver.PlanningEntityCollectionProperty]
...
class ThirdPartySolution:
    code: str
    value_list: List[ExampleValue]
    entity_list: List[ExampleExtendedThirdpartyEntity]
...
class ExampleExtendedThirdPartySolution(ThirdPartySolution):
    ...
    def get_value_list(self) -> Annotated[List[ExampleValue],
                                          timefold.solver.ProblemFactCollectionProperty,
                                          timefold.solver.ValueRangeProvider]:
        return self.value_list

    def get_entity_list(self) -> Annotated[List[ExampleExtendedThirdpartyEntity],
                                           timefold.solver.ProblemFactCollectionProperty]:
